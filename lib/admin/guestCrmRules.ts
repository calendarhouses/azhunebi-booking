 ...
 * 3. Guest ratings/notes/autocomplete must load lazy: only on Guests view or booking-drawer focus.
 * 4. Autocomplete may filter already-loaded slim bookings client-side without a CRM round-trip.
