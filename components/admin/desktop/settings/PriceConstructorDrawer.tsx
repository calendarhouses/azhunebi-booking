  ...
  return (
    <>
      <button
        type="button"
        aria-label="Закрити"
        className={cn("price-constructor-backdrop", open && "price-constructor-backdrop--open")}
        onClick={onClose}
      />
      <aside
        className={cn("price-constructor-drawer", open && "price-constructor-drawer--open")}
        role="dialog"
        aria-modal="true"
        aria-labelledby="price-constructor-title"
      >
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-stone-100 px-6 py-5">
          <div>
            <h2 id="price-constructor-title" className="text-lg font-bold text-stone-900">
              Конструктор цін
            </h2>
            <p className="mt-1 text-sm text-stone-500">Обери житло, дні та період</p>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="price-constructor-drawer__close"
            aria-label="Закрити"
          >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
          <div className="flex flex-col gap-5">
            ...
            <div>
              <SectionHeading
                customIcon={
                  <RoomSidebarHouseIcon className="price-constructor-section-heading__icon" />
                }
              >
              ...
              <div className="price-constructor-chip-grid grid grid-cols-2 gap-3">
                <ToggleCard
                  active={priceForm.allRoomsActive}
        ...
        <div className="price-constructor-drawer__footer">
          <button
            type="button"
            disabled={saving}
            onClick={() => void onSave()}
            className={cn("price-constructor-drawer__save", saving && "opacity-65 cursor-not-allowed")}
          >
