...
export function useAdminModals({
  ...
  const saveRoomDrawer = useCallback(async () => {
    ...
    const basePatch: Omit<RoomConfig, "id"> = {
      ...
      priceOneNightWeekday: roomForm.priceOneNightWeekday || 0,
      priceOneNightWeekend: roomForm.priceOneNightWeekend || 0,
      pricePerGuestOneNight: roomForm.pricePerGuestOneNight || 0,
